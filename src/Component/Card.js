...
const Card=(props)=> {
  ...
  const downloadPDF=()=>{
   ...
   {
    toast.success("Moving To Select Card Size!!");
    navigate("/choice");
   }
  return (
    <div className=" flex h-screen w-full  align-middle bg-[#fecaca]
       ...
       lg:bg-[#fecaca]
       " >
         <div className=" absolute ml-[198px] mt-[50px] h-[60px] w-[25px] bg-black -rotate-2
         md:ml-[737px] md:mt-[78px] md:h-[150px] md:w-[45px] bg-black -rotate-2" ></div>
         <div ref={pdfRef} className="bg-[url(./images/Ut.jpeg)] bg-no-repeat bg-cover 
            ...
            rounded-lg mx-auto" >
                   ...
                   <div>
                    {
                        image?<img src={URL.createObjectURL(image)} alt="" className="
                         block md:w-[330px] md:h-[320px] md:ml-[91px] rounded-full md:mt-[165px]">
                        ...
                        className=" block w-[150px] h-[150px] ml-9 rounded-full   md:w-[330px] md:h-[320px] md:ml-[91px]  md:mt-[165px]" alt=''></img>
                      }
                   </div>
                   <div className=" absolute w-5/12 mt-[166px]">
                    <p className="
                      md:text-[2.4rem] 
                      text-[1rem]  font-bold
                       max-w-[300px]
                    ...
                    <div className=" absolute ">
                      {
                        ...
                        className="mx-w-[70px] h-[40px] flex mx-auto grid ml-[220px] mt-7
                        md:mx-w-[140px] md:h-[80px] md:ml-[570px] md:mt-[70px] "></img> :
                        <img  alt=''
                        ...
                        className="mx-w-[70px] h-[40px] flex mx-auto grid ml-[220px] mt-7
                        md:mx-w-[140px] md:h-[80px] md:ml-[570px] md:mt-[70px] "
                        ></img>
                      }
                    </div>
                    <div className=" absolute flex flex-col
                          md: w-11/12 md:mx-auto md:ml-[18rem] md:gap-10 md:mt-[8rem]
                          w-11/12 mx-auto 
                          ">
                            <p className=" 
                                absolute  md:mx-auto md:text-[3.8rem] md:leading-[4rem] md:font-extrabold md:max-w-[100px] md:ml-[14rem]
                                  mx-auto text-[1.9rem] leading-[2rem] font-extrabold max-w-[100px] ml-[15.1rem] mt-[7rem]
                                  ">
                                      WELCOME ABROAD!
                            </p>
                            <h1 className=" 
                                absolute md:text-[2.5rem] 
                                mx-auto font-bold text-green-600 
                                text-[19px] ml-[14.3rem] mt-[12rem]
                                md:mt-[270px] md:ml-[200px]"><p>Get To Know Him!</p></h1>
                                <p className="
                                    absolute md:text-[1.5rem] md:font-bold md:mr-[8rem] md:mt-[330px]
                                    text-[12px] font-bold ml-[15.5rem] mt-[14rem]
                                    ">
              ...
              <div className="md:mt-[24.2rem] flex  gap-6 justify-center">
                <button className=" bg-red-500 hover:bg-green-400 
                   w-[100px] h-[35px] mt-[26rem]" onClick={downloadPDF}>
                  Downlaod
                </button>
                <button className=" bg-red-500 hover:bg-green-400 
                   w-[100px] h-[35px] mt-[26rem]" onClick={changeHandler}>
                   Select
                </button>
              </div>
